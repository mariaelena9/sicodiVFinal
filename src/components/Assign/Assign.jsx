...
class Assign extends Component {
    ...
    handleSet = () => {
        const correspondencia = {
            ...
            'fk_CorresMain': (this.state.correspondenciaInfo.fk_CorresMain === null)?this.state.correspondenciaInfo.id_Correspondencia:this.state.correspondenciaInfo.fk_CorresMain
        }
